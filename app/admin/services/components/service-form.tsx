...
export default function ServiceForm({ service, id }: ServiceFormProps) {
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="department" name="department" defaultValue={service.department} required />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="cost">Стоимость (в рублях)</Label>
                  <Input id="cost" name="cost" type="text" defaultValue={service.cost} required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="requirements" name="requirements" rows={3} defaultValue={service.requirements} required />
              </div>

              <div className="space-y-2">
                <Label htmlFor="procedure">Процедура получения</Label>
                <Textarea id="procedure" name="procedure" rows={3} defaultValue={service.procedure} required />
              </div>
            </div>
          </CardContent>
